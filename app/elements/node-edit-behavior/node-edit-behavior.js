...
var NEB = (function () {
    ...
    NEB.toggleIcon = function (e) {
        ...
        var element = window.app.util.findElementWithClassName(e.path, 'showOnContentItemCont');
    ...
    ;
    NEB.animateTriggers = function (newStates, triggersElement, callback) {
    ...
    NEB.animateContentTypeChooser = function (newStates, contentTypeChooserElement, callback) {
    ...
    NEB.selectorStateChange = function (prevState, state) {
        ...
        if (oldStates.showTriggers && !newStates.showTriggers) {
            if (oldStates.showContentTypeChooser !== newStates.showContentTypeChooser) {
                this.animateTriggers(newStates, triggersElement, function () {
                    _this.animateContentTypeChooser(newStates, triggersElement);
                });
            }
            else {
            ...
            if (oldStates.showContentTypeChooser !== newStates.showContentTypeChooser) {
                this.animateContentTypeChooser(newStates, triggersElement, function () {
                    _this.animateTriggers(newStates, triggersElement);
                });
            }
            else {
                this.animateTriggers(newStates, triggersElement);
